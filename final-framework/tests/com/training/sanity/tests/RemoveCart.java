...
public class RemoveCart {
	...
	public void addtoCartTest() {
		...
		addtoCart.cartRemove();
		
		String actualRemoveMsg=driver.findElement(By.xpath("//*[@id=\"content\"]/p")).getText();
		String expectedRemoveMsg= "Your shopping cart is empty!";
		if (actualRemoveMsg.contains(expectedRemoveMsg)) {
			System.out.println("Remove Cart Test Case Passed");
		}else {
			System.out.println("Remove Cart Test Case Failed");
		}
